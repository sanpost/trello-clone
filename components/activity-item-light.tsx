...
interface ActivityItemLightProps {
    data: AuditLog;
}

export const ActivityItemLight = ({
    data,
}: ActivityItemLightProps) => {
        ...
        <li className="flex items-center gap-x-2 ">
            ...
            <div className="flex flex-col space-y-0.5">
                <p className="text-sm text-muted-foreground">
                    <span className="font-semibold lowercase text-slate-100">
                        {data.userName}
            ...
            <div className="flex items-end flex-row ml-auto">
                <p className="space-y-4 text-xs text-neutral-200/70"  >
